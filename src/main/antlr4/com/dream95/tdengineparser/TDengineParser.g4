...
dbOptions
    : ( BUFFER NK_INTEGER
      ...
      | COMP NK_INTEGER
      | DURATION (NK_INTEGER | NK_VARIABLE)                                                            
      | MAXROWS NK_INTEGER
      | MINROWS NK_INTEGER                                                                             
      | KEEP (integerList | variableList)                                                              
      | PAGES NK_INTEGER                                                                               
      | PAGESIZE NK_INTEGER                                                                            
      | TSDB_PAGESIZE NK_INTEGER
      | PRECISION NK_STRING                                                                            
      | (REPLICAS | REPLICA) NK_INTEGER                                                                
      | VGROUPS NK_INTEGER                                                                             
      | SINGLE_STABLE NK_INTEGER
      | RETENTIONS retentionList                                                                       
      | SCHEMALESS NK_INTEGER                                                                          
      ...
      | WAL_ROLL_PERIOD NK_INTEGER                                                                     
      | WAL_SEGMENT_SIZE NK_INTEGER                                                                    
      | STT_TRIGGER NK_INTEGER
      | TABLE_PREFIX signed                                                                            
      | TABLE_SUFFIX signed                                                                            
      | SS_CHUNKPAGES NK_INTEGER
...
tableOptions
    : ( COMMENT NK_STRING
      | MAX_DELAY durationList                                                                         
      | WATERMARK durationList                                                                         
      | ROLLUP NK_LP rollupFuncList NK_RP
      | TTL NK_INTEGER                                                                                 
      | SMA NK_LP colNameList NK_RP                                                                    
      | DELETE_MARK durationList                                                                       
